...
static bool input_is_valid(const char *input)
{
...
static void print_option_usage(Option option, char *invalid_value)
{
...
static void print_options(Options options)
{
    printf("Options:\n");
...
static void print_help(Options options)
{
...
static void invalid_arg(char *invalid_arg, Options options)
{
